...
echo'<p style="color: white; text-align: center"><b> Your login is done!!</b></p>';
$uname=$_POST['uname'];
$pass=$_POST['pass'];

$EncryptPassword = md5($pass);

$sql="INSERT INTO `register`.`login` ( `uname`, `pass`, `dt`) VALUES ( '$uname', '$EncryptPassword', current_timestamp());";
//echo $sql;
...
<div class="w3-container">
    <h2 class="w3-padding-64"><b>{CoderGeeks}</b></h2>
  </div>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-white"><b><i>OUR GOALS</i></b></h1>
  ...
  <div class="w3-container" id="packages" style="margin-top:75px">
    ...
    <h3 style="color:white;><b> **Prices for our course</b></h3>
  </div>
...
<li class="w3-padding-16">CSS</li>
    ...
    <div class="w3-half">
      <ul class="w3-ul w3-light-blue w3-center">
        <li class="w3-light-grey w3-xlarge w3-padding-32 "><b>Pro</b></li>
...
<div class="w3-container" id="demo" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-white"><i><b>Demo Lectures</b></i></h1>
...
<div class="w3-container" id="login" style="margin-top:75px">
 ...
 <h5 class="w3-xlarge w3-text-white"><b><i>Please login here:</i></b></h5>
    ...
    <form action="login.php" method="post">
      ...
      <button id="myButton" class="float-left submit-button w3-button w3-block w3-padding-large w3-blue w3-margin-bottom" >Login</button>
