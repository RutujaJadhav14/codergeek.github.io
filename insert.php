...
echo'<p style="color: white; text-align: center"><b> Your registration is successfully done!!</b></p>';
$Name=$_POST['Name'];
$Gender=$_POST['Gender'];
$Email=$_POST['Email'];
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-white"><b>Our Goals</b></h1>
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-white"><b>THE TEAM</b></h1>
  ...
  <div class="w3-container" id="packages" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-white"><b>Packages</b></h1>
